    ...
    <div className="max-w-4xl w-full mx-auto p-4 md:p-8 space-y-6">
      ...
      <div className="flex items-center justify-between pb-4 border-b border-border">
        ...
        <button
          ...
          className={`px-4 py-2 rounded-2xl font-bold text-xs flex items-center gap-2 shadow-xs transition-all cursor-pointer ${
            isOnline
          ...
          <div className="bg-card border border-border rounded-3xl p-6 max-w-sm w-full space-y-5 shadow-2xl">
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-4">
              <input
                ...
                className="w-full text-center text-3xl font-mono font-black tracking-widest py-3 rounded-2xl bg-card-elevated border border-border text-foreground focus:outline-hidden focus:border-emerald-500"
              />
