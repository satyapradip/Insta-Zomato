    ...
    <div className="min-h-screen bg-background text-foreground flex justify-center pb-24 lg:pb-8">
      ...
      <main className="flex-1 lg:pl-64 max-w-4xl w-full p-4 md:p-8 space-y-6">
        ...
        {mounted && isAuthenticated && user ? (
          ...
          <div className="bg-card border border-primary/30 rounded-3xl p-6 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4 bg-linear-to-r from-primary/5 via-card to-card">
