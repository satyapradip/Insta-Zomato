    ...
    <div className="max-w-4xl w-full mx-auto p-4 md:p-8 space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {SAVED_DISHES.map((dish) => (
          <div
            key={dish.id}
            className="bg-card border border-border rounded-3xl p-4 flex items-center justify-between gap-4 shadow-xs hover:border-primary/30 transition-all"
          >
            ...
            <div className="flex flex-col items-end gap-2 shrink-0">
              <button
                ...
                className="bg-primary hover:bg-primary-hover text-white text-xs font-bold py-1.5 px-3 rounded-xl transition-colors flex items-center gap-1 shadow-xs cursor-pointer"
              >
              ...
              <Link
                href="/feed"
                className="text-[10px] text-muted hover:text-foreground flex items-center gap-0.5 cursor-pointer"
              >
